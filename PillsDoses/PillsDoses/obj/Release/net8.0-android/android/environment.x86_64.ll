...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2367369709737662925, ; hash 0x20da963548eed9cd, from name: aot-PillsDoses.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 56
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 6893611059845305772, ; hash 0x5fab06bc29c895ac, from name: libaot-PillsDoses.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 154
	...
	%struct.DSOCacheEntry {
		i64 8882205470632708049, ; hash 0x7b43eed0cb1807d1, from name: PillsDoses.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 224
	...
	%struct.DSOCacheEntry {
		i64 11936800428372841535, ; hash 0xa5a808bee7e4d43f, from name: PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 304
	...
	%struct.DSOCacheEntry {
		i64 13010875959353231378, ; hash 0xb48feac01deb4812, from name: aot-PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 335
	%struct.DSOCacheEntry {
		i64 13030639822594390440, ; hash 0xb4d621e11dcc39a8, from name: libaot-PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 336
...
@.env.3 = private unnamed_addr constant [37 x i8] c"744a4eea-d08e-4e77-a29c-4e507184c6b2\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.pillsdoses\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [25 x i8] c"libaot-PillsDoses.dll.so\00", align 16
