...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 486200588, ; hash 0x1cfad50c, from name: libaot-PillsDoses.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 764947190, ; hash 0x2d982af6, from name: aot-PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 75
	...
	%struct.DSOCacheEntry {
		i64 1129673745, ; hash 0x43557411, from name: aot-PillsDoses.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 118
	...
	%struct.DSOCacheEntry {
		i64 1782022986, ; hash 0x6a37834a, from name: PillsDoses.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 188
	...
	%struct.DSOCacheEntry {
		i64 2727027662, ; hash 0xa28b23ce, from name: PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 307
	...
	%struct.DSOCacheEntry {
		i64 2767302600, ; hash 0xa4f1afc8, from name: libaot-PillsDoses
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-PillsDoses.dll.so
		ptr null; void* handle (0x0)
	}, ; 315
